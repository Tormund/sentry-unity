...
public class ScriptableSentryUnityOptions : ScriptableObject
{
    ...
    [field: SerializeField] public bool VisionOsNativeSupportEnabled { get; set; } = true;
...
#pragma warning restore CS0618
            ...
            VisionOsNativeSupportEnabled = VisionOsNativeSupportEnabled,
            ...
            || options.Experimental.LinuxBackend == LinuxBackend.Native)
        {
            ...
            {
                options.LogInfo(
                    "Native backend: raising ShutdownTimeout from {0}ms to the {1}ms floor.",
